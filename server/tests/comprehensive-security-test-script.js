...
/**
 * APDS7311 - ST10389916 - COMPREHENSIVE SECURITY TEST SCRIPT
 * Complete security testing suite for Customer  application
...
async function startServer() {
    return new Promise((resolve, reject) => {
        colorLog('🚀 Starting Customer  server for security testing...', 'blue');
...
async function runComprehensiveSecurityTests() {
    colorLog('🛡️  APDS7311 - ST10389916 COMPREHENSIVE SECURITY TEST SUITE STARTING', 'cyan');
