    ...
    <div className="auth-wrapper">
      ...
      <div className="auth-glass-card">
        ...
        <div className="auth-header-modern">
          <h2>Customer Secure Login</h2>
          <p>GlobalPay international banking account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="auth-form-modern">
          ...
          <div className="input-group">
            ...
            <input
              ...
              required
            />
            <small>Enter your registered bank account number</small>
          </div>
        ...
        <div className="auth-footer-modern">
          ...
          <div className="portal-switch-modern">
            <p>
              <Link to="/employee/login" className="auth-link-modern">
                Employee 
              </Link>
            </p>
          </div>
